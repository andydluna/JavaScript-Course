...
const checkDogs = function (dogsJulia, dogsKate) {
  const revisedDogs = dogsJulia.slice(1, -1);
  const dogsAges = revisedDogs.concat(dogsKate);
...
// // Maximum value
// const maxVal = movements.reduce((acc, cur) => (acc < cur ? cur : acc));
// console.log(maxVal);
...
//       i === arr.length - 1 ? (acc + curr) / arr.length : acc + curr
//     );
// };
...
// // Some Condition
// console.log(movements.some(move => move > 1300));
// // Every Condition
...
// // Numbers
// console.log(movements);
// // if return < 0, a before b, otherwise, b before a
...
//   console.log(movementsUI2.textContent);
// });
...
// console.log(dogs.some(dog => okayDog(dog)));

// // 7.
// const okayDogs = dogs.filter(dog => okayDog(dog));
// console.log(okayDogs);

// // 8.
// const sortedDogs = okayDogs
//   .slice(0)
