...
// - What should I print if the temperature is not a number?
// - How to place the dots before and after?

// 2) Breaking up into smaller sub-problems
// - Create function printForecast(arr) -> null
//  - Declare a string called result "... "
//  - Loop over the array from 0 to len - 1 using i
//  - If the element at i is not a number, continue
//  - else, add it to the result string with the format
//  - print the result string
// - Call the printForecast function
